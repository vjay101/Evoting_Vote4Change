...
<html>
    <head>
        ...
        <link href="stylesheet/showusers.css" rel="stylesheet">
        <title>Manage User Options</title>
    </head>
    <body>
        <%
        ...
        "<div class='subcandidate'>Manage Users Page</div><br><br>"+
            ...
            displayBlock.append("<div id='dv2' onclick='removeuser()'><img src='images/delete.jpg' height='300px' width='300px'><br><h3>Remove Users</h3></div>");
